...
def special(char_name: str, char_class: str) -> str:
    """Выводит информацию про применение спецспособности."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Выводит информацию про выбранный класс персонажа."""
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Описывает доступные классы персонажей и фиксирует выбор игрока."""
    approve_choice: str = ''
    char_class: str = ''
